...
public class stockIncrease extends javax.swing.JFrame {
 ...
 private void stockdetail() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 360, -1));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(77, 467, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(556, 467, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       int sum = unit+temp;
      // JOptionPane.showMessageDialog(null,"  ands "+sum);
        try {
            ...
            pstm.setInt(1,sum);
             pstm.executeUpdate();
             stockdetail();
             JOptionPane.showMessageDialog(null,"stock Increase");
             } catch (Exception e) {
