...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 360, 40, 20));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 360, 301, -1));

        jPasswordField1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 400, 301, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 1430, 810));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(email.equals("hitesh")&&password.equals("admin"))
        {
            check=1;
            setVisible(false);
            ...
            try {
                if(rs.next())
                {
                    ...
                    if(rs.getString(7).equals("true"))
                    {
                        ...
                        JOptionPane.showMessageDialog(null,"Wait For Admin Apporval");
                }
            }
            catch (Exception e) 
            {
